...
const experiences = [
  {
    ...
    company: 'Agape Personality Development School',
    period: '2025 - Present',
  ...
  {
    icon: Users,
    title: 'Co-Chief Operational Officer',
    company: 'Innovation and Entrepreneurship Development Cell CCE',
    period: '2025 - Present',
    ...
    company: 'Techletics 2025 Executive Committee',
    period: '2025 - Present',
    description: 'Created posters, event creatives, and digital assets for university events and campaigns.',
  },
      {
    icon: Users,
    title: 'Core Member',
    company: 'Beach Hack Season 7 Executive Committee',
    period: '2025 - Present',
    description: 'Created posters, event creatives, and digital assets for university events and campaigns.',
  },
];
